...
class Home extends CI_Controller
{
    ...
    function product_view($para1 = "",$para2 = "")
    {
     ...
     if ($para1 == 'edit') {
        $page_data['product_data'] = $this->db->get_where('product', array(
            ...
            $page_data['sale_price']         = $this->input->post('sale_price')
    ...
    function logout()
    {
        $this->session->sess_destroy('alert', 'successful_signout');
        redirect(base_url() . 'index.php/home/', 'refresh');
    }
    ...
    function cart($para1 = '', $para2 = '', $para3 = '', $para4 = '')
    {
        ...
        if ($para1 == 'calcs') {
            ...
            $tax   = $this->crud_model->get_type_name_by_id('business_settings', '26', 'value');
            $grand = $total + $shipping + ($tax*$total)/100;
            if ($para2 == 'full') {
                $ship  = $shipping;
