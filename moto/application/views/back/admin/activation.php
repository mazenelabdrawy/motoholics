                                    ...
                                    <div class="panel-heading bg-white">
                                        <center>
                                            <h4 class="panel-title">
                                                <?php echo translate('products_activation')?>
                                            </h4>
                                        </center>
                                    </div>
                                           ...
                                           <div class="col-sm-4 col-sm-offset-5">
                                               <input class='aiz_switchery1' type="checkbox" 
                                                    data-set='physical_product_set' 
                                                        data-id='68'
                                                            data-tm='<?php echo translate('products_enabled'); ?>' 					       	data-fm='<?php echo translate('products_disabled'); ?>'
                            ...
                            <div class="col-md-4">
                                <div class="panel">
                                    <div class="panel-heading bg-white">
                                        <center>
                                            <h4 class="panel-title">
                                                <?php echo translate('other_product_activation')?>
                                            </h4>
                                        </center>
                                    </div>
                                            ...
                                            <div class="col-sm-4 col-sm-offset-5">
                                               <input class='aiz_switchery1' type="checkbox" 
                                                    data-set='digital_product_set' 
                                                        data-id='69'
                                                            data-tm='<?php echo translate('other_product_enabled'); ?>' 					              			data-fm='<?php echo translate('other_product_disabled'); ?>'
