...
$tp_val    = $this->db->get_where('business_settings', array(
    'type' => 'tax_cost'
))->row()->value;
$tp_type   = $this->db->get_where('business_settings', array(
    'type' => 'tax_cost_type'
))->row()->value;
...
<div id="content-container">
    <div id="page-title">
        <center>
        	<h1 class="page-header text-overflow">
				<?php echo translate('manage_payment_methods_,_shipment_&_Tax_Settings')?>
            </h1>
        </center>
    </div>
    <?php
    ...
    <div class="panel-heading">
    <center>
        <h3 class="panel-title"><?php echo translate('tax_settings')?></h3>
    </center>
</div>
<div class="panel-body" style="background:#fffffb;">
    <div class="form-group">
        <label class="col-sm-3 control-label" ><?php echo translate('tax_cost_type');?></label>
        <div class="col-sm-6">
            <select name="tax_cost_type" class="demo-cs-multiselect">


                <option value="percent"
                    <?php if($tp_type == 'fixed_percent'){ echo 'selected'; } ?> >
                    <?php echo translate('fixed percent');?>
                </option>
            </select>
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label" ><?php echo translate('tax_cost_(If_fixed)');?> (<?php echo '%'; ?>)</label>
        <div class="col-sm-6">
            <input type="text"  name="tax_cost"
                   value="<?php echo $tp_val; ?>"
                   class="form-control">
        </div>
    </div>
</div>
