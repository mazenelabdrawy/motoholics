															...
															$page_name=="stock" || 
                                            					$page_name=="digital" ){?>
                                                                             		in
                                                                                		<?php } ?> >" >
							<?php
                                if( $membership !== '8'&& $membership !== '0'&&$this->crud_model->vendor_permission('product') ||
                                    $membership !== '8'&& $membership !== '0'&& $this->crud_model->vendor_permission('stock') ){
                            ?>
                            <!--Menu list item-->
                                <li <?php if($page_name=="product" ||
                                            	$page_name=="stock" ){?>
                                    ...
                                    <ul class="collapse <?php if($page_name=="product" ||
                                        ...
                                        <?php if($membership !== '8'&& $membership !== '0'&& $this->crud_model->vendor_permission('product')){
                                        ?>
                                        ...
                                        <?php
                                            } if($membership !== '8'&& $membership !== '0'&&$this->crud_model->vendor_permission('stock')){
                                        ?>
                            ...
                            <!--Menu list item-->
                                <li <?php if($page_name=="digital"){?> class="active-link" <?php } ?> >
                                    <a href="<?php echo base_url(); ?>index.php/vendor/digital">
                                        <i class="fa fa-list"></i>
                                            <?php echo translate('Individual_&_Dealer_Products');?>
                                    </a>
                                </li>
                            ...
                            ?>
                                ...
                                if($membership !== '8'&& $membership !== '0'&& $this->crud_model->vendor_permission('digital') ){
                                    ...
                                    <li <?php if($page_name=="digital"){?> class="active-link" <?php } ?> >
                                        <a href="<?php echo base_url(); ?>index.php/vendor/digital">
                                            <i class="fa fa-list"></i>
                                            <?php echo translate('Motorcycles');?>
                                        </a>
                                    </li>
